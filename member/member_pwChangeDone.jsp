...
<body class="h-100">
    ...
    ********************-->
	...
	<div id="member_pwChangeDone" class="login-form-bg h-100">
						...
						<div class="card login-form mb-0">
							<div class="card-body pt-5">
								<a class="text-center" href="memberLoginForm">
									<h4>Password Change Result</h4>
								</a>

								<div class="mt-5 mb-5 login-input">
									<div class="form-group">
										<label class="form-control">${msg}</label>
									</div>
									<button type="button" class="btn login-form__btn sign-in_btn w-100" onclick="location.href='memberLoginForm'">Move Login</button>
								</div>
							</div>
						</div>
					</div>
