...
<body>
	<form id="saleInsertForm">
		<div class="card">
			<div class="card-body">
				<div class="top">
					<h4 id="title" class="card-title top-left mb-0">매출 등록</h4>
				...
				<table
					...
					<tbody>
						<tr>
							<td colspan="2" id="venderSaleNum">
								<div class="form-group input-group" data-toggle="tooltip"
									data-placement="top" title="거래처 선택시 자동 입력됩니다.">
									<input type="text" id="saleNumLabel" class="form-control"
										readonly="readonly" value="매출번호"> <input type="text"
										id="yyyy" name="yyyy" class="form-control" readonly="readonly">
									<input type="text" id="mm" name="mm" class="form-control"
										readonly="readonly"> <input type="text" id="dd"
										name="dd" class="form-control" readonly="readonly"> <input
										type="text" id="no" name="no" class="form-control"
										readonly="readonly"> <input type="text" id="hang"
										name="hang" class="form-control" readonly="readonly">
								</div>
							</td>
							<td>
								<div
									...
									<input type="text" class="form-control" readonly="readonly"
										value="거래처"> <select id="vendCode" name="vendCode"
										class="form-control">
						...
						<tr>
							...
							<td>
								<div
									...
									<input type="text" class="form-control" readonly="readonly"
										value="매출수량"> <input type="text" id="qty" name="qty"
										class="form-control">
								</div>
							</td>
						</tr>
	...
	<div id="listCard" class="card">
		<div class="card-body">
			<h4 class="card-title">매출 목록</h4>
			<div class="table-responsive">
				<table id="saleInsertList"
					...
					<tbody>
						<c:forEach var="saleList" items="${saleList}">
							<tr>
								<td>${saleList.seq}</td>
								<td>${saleList.v_name}</td>
								<td>${saleList.p_name}</td>
								<td>${saleList.price}</td>
								<td>${saleList.qty}</td>
								<td>${saleList.total}</td>
								<td>${saleList.date}</td>
							</tr>
						</c:forEach>
					</tbody>
	...
	<content tag="local_script"> <script
		src="resources/js/buyandsale/sale_insert.js">
		
	</script> <script src="resources/js/toastr.min.js">
