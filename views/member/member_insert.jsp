...
<body class="h-100">
    ...
    ********************-->
	...
	<div id="memberInsertForm" class="login-form-bg h-100">
						...
						<div class="card login-form mb-0">
							<div class="card-body pt-5">
								...
								<div class="mt-5 mb-5 login-input">
									<div class="input-group form-group">
										<input type="email" id="email" class="form-control"
											placeholder="Email"><div class="input-group-append">
										<button type="button" id="emailConfirm" class="btn login-form__btn sign-in_btn w-100">Check</button>
										</div>
									</div>
									<input type="hidden" id="emailBase" value="y"> <input
										type="hidden" id="emailCheck" value="n">
								...
								<div class="col-sm-12 mt-3">
									<label> Available after email verification </label>
								</div>
								<div class="col-sm-12">
									<label> Enter the available email </label>
								</div>
								</p>
